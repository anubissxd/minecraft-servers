...
# Subfolders under PackRoot that get synced to players, so a fresh install
# matches the maintainer's own client exactly. Files the game rewrites itself
...
# cleared from PackRoot\mods before running this, or they ship too.
$ExcludedFiles = @()
